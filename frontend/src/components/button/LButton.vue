...
const buttonClasses = cva({
  ...
  variants: {
    variant: {
      ...
      muted:
        'bg-transparent text-zinc-600 hover:text-zinc-700 active:text-zinc-800 hover:bg-zinc-100 active:bg-zinc-200 disabled:text-zinc-400 disabled:hover:bg-transparent',
    },
    size: {
      sm: 'px-2 py-1.5',
      base: 'px-3 py-2',
  ...
  compoundVariants: [
    {
      ...
      context: 'danger',
      class:
        'bg-red-600 ring-red-700/60 hover:bg-red-600/80 active:text-white active:bg-red-600/70 disabled:bg-red-300 disabled:text-red-50 disabled:ring-red-300/90',
    },
    {
      variant: 'secondary',
      context: 'danger',
...
const iconVariants = {
  ...
  secondary:
    'text-zinc-800/80 group-hover:text-zinc-900/80 group-active:text-zinc-900/80',
  tertiary:
    'text-zinc-800/80 group-hover:text-zinc-900/80 group-active:text-zinc-900/80',
  muted: '',
};
